...
mobs:register_spawn("mobs:kitten", {"default:dirt_with_grass", "ethereal:grove_dirt", "woodsoils:dirt_with_leaves_1", "woodsoils:dirt_with_leaves_2"}, 20, 10, 15000, 1, 31000)
