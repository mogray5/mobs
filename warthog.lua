...
mobs:register_mob("mobs:pumba", {
  ...
  biome_food_types = {"mobs:egg", "farming:pumpkin_8","farming_plus:tomato","farming:coffee_5",
...
mobs:register_spawn("mobs:pumba", {"ethereal:mushroom_dirt", "default:dirt_with_grass","default:dirt", "ethereal:green_dirt"}, 20, 10, 15000, 1, 31000)
